...
// values. Services map these to reason codes.
var (
	...
	// signature (remote flows use a signature). Maps to err:credential:binding-failed.
	...
	// documentErrors is non-empty ([ISO/IEC 18013-5 §8.3.2.1.2.3] Table: 0 = OK).
	// The wallet itself signaled a problem producing the response; treated as
	// untrustworthy as a whole rather than partially trusted.
